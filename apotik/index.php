...
<html lang="en">
	<head>
	    ...
	    <title>ADMIN RSJ KALAWA ATEI</title>
    ...
    <div class="container">
    	...
    	<form>
    		<div style="background-color:#000000;"  class="jumbotron">
				...
				<button type="button" class="btn btn-lg btn-success next_getway">PANGGIL <span class="glyphicon glyphicon-chevron-right"></span></button>
				<p id="peringatan">
  	...
  	<script type="text/javascript">
			$("document").ready(function()
			{
				...
				$(".next_getway").click(function(){
					...
					$.post( "../apps/admin_getway_apotik_fix_number.php", {"next_current": next_current,"next_repeat": next_repeat,"nomor_loket": nomor_loket,"nomor_antrian": nomor_antrian,"idt": idt}, function( data ) {
				...
				$(".goRepeat").click(function(){
					...
					$.post( "../apps/admin_getway_apotik_fix_number.php", {"next_current": next_current,"next_repeat": next_repeat,"nomor_loket": nomor_loket}, function( data ) {
						if(data['peringatan'] == 1){
							$('#peringatan').show();
						}
						$(".next").html(data['next']);
			...
			function showDiv(gIdL)
		    {
		        ...
		        $(document).ready(function()
		        {
		            $("#welcomeDiv2Cri").load('list_pasien_mid.php?IdL='+gIdL);
		        });
