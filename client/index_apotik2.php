...
if ($row['id'] == NULL) {
    ...
    $no_urut_antrian = $row['id'] + 1;
}

//echo $no_urut_antrian;
...
$jaminan = $response_data->data;
									...
									<input type="hidden" id="hidden_nomor_antrian" name="hidden_nomor_antrian" value='<?php echo $no_urut_antrian; ?>'>
								</td>
													<td width="9">&nbsp;</td>
													<td>&nbsp;</td>
												</tr>
...
<script type="text/javascript">
        ...
        $("document").ready(function()
        {
			...
			var uri       = "../apps/daemon_serve_client_apotik.php";
			
			//var uri_cetak_tiket = "../apps/daemon_cetak_tiket_apotik.php";
			var uri_cetak_tiket = "cetak_antrian.php";
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    no_antrian = no_antrian_db + 1
                    $("#no_urut").html("Ambil Antrian Nomor "+ no_antrian);
                    //$("#hidden_nomor_antrian").html(data["next"]);
        ...
        function showDoc(aX) {
			...
			//alert($("#hidden_loket").val());
			//alert('aaaa ->' +$("#hidden_nomor_antrian").val())
