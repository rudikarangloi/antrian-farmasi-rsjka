      ...
      <div class="container">
        <div class="row">          
          <div class="col-lg-4">
		   ...
		   <div class="col-lg-4">
            <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
              <a href="https://simpus.palangkaraya.go.id/antrian/system/pages/client/form_scan_qr.php">
                <div class="features-icons-icon d-flex">
                  <i class="icon-camera m-auto text-primary"></i>
                </div>
              </a>
              <h3><a href="https://simpus.palangkaraya.go.id/antrian/system/pages/client/form_scan_qr.php">Konfirmasi Antrian</a></h3>
              <p class="lead mb-0"></p>
            </div>
          </div>
